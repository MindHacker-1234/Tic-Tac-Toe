...
import addPageScript from './Turn_Copy.script';
import styles from './Turn_Copy.style';
import getVariables from './Turn_Copy.variables';
    ...
    >
      ...
      >
                          ...
                          >
                            ...
                            >
                              <WmPicture
                                ...
                                styles={{
                                  root: { height: 90, marginTop: 9, width: 75 },
                                  text: {},
                                }}
                                listener={fragment}
                              ></WmPicture>
        ...
        <WmLinearlayoutitem
          ...
          marginTop="4"
          styles={{
            root: { marginTop: 4, paddingLeft: 50, width: '85%' },
            text: {},
          }}
          classname="board"
          listener={fragment}
        ...
        <WmLinearlayoutitem
          ...
          styles={{
            ...
            text: { fontFamily: 'SofiaPro', textAlign: 'center' },
          }}
          listener={fragment}
        >
          <WmButton
...
export default class Turn_CopyPage extends BasePage {
  components;
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('Turn_Copy-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('Turn_Copy-styleOverrides', styleOverrides);
    }
  }
