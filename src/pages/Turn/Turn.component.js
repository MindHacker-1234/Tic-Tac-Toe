...
import addPageScript from './Turn.script';
import styles from './Turn.style';
import getVariables from './Turn.variables';
  ...
  return (
    ...
    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <WmPicture
                              resizemode="contain"
                              name="picture1"
                              picturesource={fragment.pageParams.playeravatar}
                        ...
                        >
                          ...
                          >
                            <WmLabel
                              name="label6"
                              caption={fragment.pageParams.playerchoice}
                              styles={{
                                root: {
                                  color: '#C4A8FF',
                                  fontSize: 40,
                  ...
                  >
                    ...
                    >
                      ...
                      <WmLinearlayout
                        ...
                        verticalalign="center"
                        styles={{
                          root: { height: 63, paddingTop: 4, paddingBottom: 4 },
                          text: {},
                        }}
      ...
      <WmLinearlayout
        ...
        spacing="4"
        name="linearlayout6"
        styles={{ root: { paddingTop: 30 }, text: {} }}
        classname="linear6"
        listener={fragment}
      >
        <WmLinearlayoutitem
      ...
      <WmLayoutgrid
        ...
        listener={fragment}
      >
        <WmGridrow name="gridrow13" classname="grid99-row" listener={fragment}>
          <WmGridcolumn
            columnwidth={6}
            xscolumnwidth={12}
            name="gridcolumn16"
            classname="grid99-cell"
            listener={fragment}
          >
            <WmContainer
              name="container16"
...
export default class TurnPage extends BasePage {
  ...
  constructor(props) {
    ...
    this.theme = this.theme.$new('Turn-styles', styles);
    if (styleOverrides) {
      this.theme = this.theme.$new('Turn-styleOverrides', styleOverrides);
    }
  }
