export default {
    ...
    fonts : [
        ...
        {
            name: 'SignPainter',
            path: require('./Roboto/SignPainter-HouseScript-Regular.ttf')
        },
        {
            name: 'SofiaPro-Regular',
            path: require('./Roboto/SofiaProRegular.ttf')
        },
        {
            name: 'SofiaPro-SemiBold',
            path: require('./Roboto/SofiaProSemiBold.ttf')
        },
    ]
};
